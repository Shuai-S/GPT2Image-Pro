...
| postExternalPptGenerations / PsdGenerations（POST /v1/ppts、/v1/psds） | api-route | editable-file-generations.ts:99/105 | api-key + 能力位 export.ppt/export.psd；PSD 强校验非空图 | 否 | 同 runEditableFileForUser + keep-alive | 非幂等；底层 sourceRef 幂等 |
