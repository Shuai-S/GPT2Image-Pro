...
`,
    ...
    codex: {
      ...
      valid: [
        ...
        "页面 Chat 每次请求扣 1 积分；页面 Agent 每个自动续跑轮次扣 1 积分，完成的图片输出另按实际尺寸和完成数量计费。",
      ],
      invalid: [
...
`,
    ...
    codex: {
      ...
      valid: [
        ...
        "Page Chat charges 1 credit per request. Page Agent charges 1 credit per automatic round; completed image outputs are billed additionally by detected size and count.",
      ],
      invalid: [
